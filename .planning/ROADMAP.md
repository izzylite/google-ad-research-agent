...
- [ ] 10-00-PLAN.md — Wave 0: test scaffolding (test_export_csv.py + test_render_report.py extension + 11 fixtures including 3 byte-exact golden CSVs + export_csv.py MODULE_MISSING stub)
