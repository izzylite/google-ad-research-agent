...
**Status:** Complete (initial close 2026-05-15 via Plans 16-00..02 shipped ADGM-07..10 + ADGM-11 deferred under option-a; gap-closure cycle 2026-05-15 via Plans 16-03 RED + 16-04 GREEN landed the structural fix and satisfied ADGM-11 at 50.75% live Lake Worth coverage; Plan 16-05 final docs closeout is the true phase closeout). All 5 requirements complete.
...
- [x] 16-03-PLAN.md — Wave 2 gap-closure: 4 RED tests + xfail-removal for per-source max-Jaccard contract; suite ran 3 FAILED + 20 PASSED proving Plan 16-04 had a clean GREEN target
- [x] 16-04-PLAN.md — Wave 2 gap-closure: per-source max-Jaccard structural fix (commit 6574f14) + thresholds option-d {0.30, 0.08} (commit 78d5851) + shape-bug fix nested→flat at perf_fetch ↔ ad_group_match reader/writer boundary (commit 56d4196, Rule 3 Blocking deviation surfaced during live e2e); live Lake Worth coverage 50.75% operator-approved — ADGM-11
- [ ] 16-05-PLAN.md — Wave 3 docs closeout: final phase docs + REQUIREMENTS.md ADGM-11 Complete + shape-contract note in references doc
...
| 16. Ad Group Mapping Token-Bag Enrichment | 5/6 | In Progress|  |
